...
from autogen_agentchat.teams import StopMessageTermination, RoundRobinGroupChat, SelectorGroupChat
...
model_capabilities = ModelCapabilities(function_calling=True, json_output=True, vision=False)

model_client = AzureOpenAIChatCompletionClient(
    azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),
    azure_deployment=os.getenv("AZURE_OPENAI_GPT4_DEPLOYMENT_MODEL_NAME"),
    api_version=os.getenv("AZURE_OPENAI_GPT4_API_VERSION"),
...
#     azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),
#     azure_deployment=os.getenv("AZURE_OPENAI_O1_DEPLOYMENT_MODEL_NAME"),
